...
local function swap_node(pos, name)
	...
	if name == "ec_furnaces:dark_matter_furnace_active" or name == "ec_furnaces:red_matter_furnace_active" then
...
local function furnace_node_timer(pos, elapsed)
	...
	srclist = inv:get_list("src") --[[@as table<core.ItemStack>]]
...
---@diagnostic disable-next-line: cast-local-type
	...
	if active then
		...
		swap_node(pos, "ec_furnaces:"..matter_type:lower().."_matter_furnace_active")
		-- make sure timer restarts automatically
		result = true
	else
		swap_node(pos, "ec_furnaces:"..matter_type:lower().."_matter_furnace")
...
if core.get_modpath("screwdriver") then
	...
	after_rotate_active = function(pos)
		...
		if node.name == "ec_furnaces:dark_matter_furnace" or node.name == "ec_furnaces:red_matter_furnace" then
			return
		end
		spawn_flames(pos, node.param2)
...
local active_def = {
	...
	drop = "ec_furnaces:dark_matter_furnace",
...
core.register_node("ec_furnaces:dark_matter_furnace", table.copy(inactive_def))
core.register_node("ec_furnaces:red_matter_furnace", table.copy(inactive_def))
core.register_node("ec_furnaces:dark_matter_furnace_active", table.copy(active_def))
core.register_node("ec_furnaces:red_matter_furnace_active", table.copy(active_def))

core.override_item("ec_furnaces:red_matter_furnace", {
...
core.override_item("ec_furnaces:red_matter_furnace_active", {
	...
	drop = "ec_furnaces:red_matter_furnace",
...
core.register_craft({
	output = "ec_furnaces:dark_matter_furnace",
	recipe = {
		{ "ec_matter:dark_matter_block", "ec_matter:dark_matter_block", "ec_matter:dark_matter_block" },
		{ "ec_matter:dark_matter_block", furnace_itemstring, "ec_matter:dark_matter_block" },
		{ "ec_matter:dark_matter_block", "ec_matter:dark_matter_block", "ec_matter:dark_matter_block" },
	}
})

core.register_craft({
	output = "ec_furnaces:red_matter_furnace",
	recipe = {
		{ "", "ec_matter:red_matter_block", "" },
		{ "ec_matter:red_matter_block", "ec_furnaces:dark_matter_furnace", "ec_matter:red_matter_block" },
	}
})

core.register_lbm({
	label = "Active furnace flame particles",
	name = "ec_furnaces:furnace_flames",
	nodenames = {"ec_furnaces:dark_matter_furnace_active","ec_furnaces:red_matter_furnace_active"},
...
core.register_alias("exchangeclone:dark_matter_furnace", "ec_furnaces:dark_matter_furnace")
core.register_alias("exchangeclone:dark_matter_furnace_active", "ec_furnaces:dark_matter_furnace_active")
core.register_alias("exchangeclone:red_matter_furnace", "ec_furnaces:red_matter_furnace")
core.register_alias("exchangeclone:red_matter_furnace_active", "ec_furnaces:red_matter_furnace_active")