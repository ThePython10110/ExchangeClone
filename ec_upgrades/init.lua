...
function exchangeclone.register_upgrade(itemstring, name, modifier, recipe, enchantment, level, upgradable_items)
    ...
    core.register_alias("exchangeclone:"..itemstring:sub(12), itemstring)
end
...
local function upgrader_action(pos)
    ...
    local upgrade_def = upgrade:get_definition() --[[@as core.ItemDef]]
...
core.register_node("ec_upgrades:upgrader", {
...
if exchangeclone.pipeworks then
    ...
    core.override_item("ec_upgrades:upgrader", {tube = {
        input_inventory = "dst",
...
core.register_craft({
    output = "ec_upgrades:upgrader",
    recipe = {
        {"ec_matter:dark_matter_block", "mcl_deepslate:tuff", "ec_matter:dark_matter_block"}, -- Tuff has to be useful SOMEHOW...
        {"mcl_deepslate:tuff", "ec_phil:philosophers_stone", "mcl_deepslate:tuff"},
        {"ec_matter:red_matter_block", "mcl_deepslate:tuff", "ec_matter:red_matter_block"}
    },
    replacements = {{"ec_phil:philosophers_stone", "ec_phil:philosophers_stone"}}
})


core.register_craftitem("ec_upgrades:blank_upgrade", {
...
exchangeclone.register_upgrade(
    "ec_upgrades:fire_aspect_1_upgrade",
    "Fire Aspect I Upgrade",
    "^[multiply:#ff0000",
    {
        {"ec_matter:dark_matter", "mcl_nether:magma", "ec_matter:dark_matter"},
        {"mcl_nether:magma", "ec_upgrades:blank_upgrade", "mcl_nether:magma"},
        {"ec_matter:dark_matter", "mcl_nether:magma", "ec_matter:dark_matter"},
    },
    "fire_aspect",
    1,
    {
        ["ec_tools:dark_matter_sword"] = true,
        ["ec_tools:red_matter_sword"] = true,
        ["ec_tools:dark_matter_axe"] = true,
        ["ec_tools:red_matter_axe"] = true,
        ["ec_tools:red_katar"] = true,
        ["ec_tools:red_katar_3x3"] = true,
    }
)

exchangeclone.register_upgrade(
    "ec_upgrades:fire_aspect_2_upgrade",
    "Fire Aspect II Upgrade",
    "^[multiply:#ffaa00",
    {
        {"ec_matter:dark_matter", "mcl_nether:magma", "ec_matter:dark_matter"},
        {"mcl_nether:magma", "ec_upgrades:fire_aspect_1_upgrade", "mcl_nether:magma"},
        {"ec_matter:dark_matter", "mcl_nether:magma", "ec_matter:dark_matter"},
    },
    "fire_aspect",
    2,
...
exchangeclone.register_upgrade(
    "ec_upgrades:knockback_1_upgrade",
    "Knockback I Upgrade",
    "^[multiply:#777777",
    {
        {"ec_matter:dark_matter", "mcl_core:slimeblock", "ec_matter:dark_matter"},
        {"mcl_core:slimeblock", "ec_upgrades:blank_upgrade", "mcl_core:slimeblock"},
        {"ec_matter:dark_matter", "mcl_core:slimeblock", "ec_matter:dark_matter"},
    },
    "knockback",
    1,
...
exchangeclone.register_upgrade(
    "ec_upgrades:knockback_2_upgrade",
    "Knockback II Upgrade",
    "^[multiply:#aaaaaa",
    {
        {"ec_matter:dark_matter", "mcl_core:slimeblock", "ec_matter:dark_matter"},
        {"mcl_core:slimeblock", "ec_upgrades:knockback_1_upgrade", "mcl_core:slimeblock"},
        {"ec_matter:dark_matter", "mcl_core:slimeblock", "ec_matter:dark_matter"},
    },
    "knockback",
    2,
...
exchangeclone.register_upgrade(
    "ec_upgrades:looting_1_upgrade",
    "Looting I Upgrade",
    "^[multiply:#33aa00",
    {
        {"ec_matter:dark_matter", "mcl_mobitems:blaze_rod", "ec_matter:dark_matter"},
        {"mcl_mobitems:blaze_rod", "ec_upgrades:blank_upgrade", "mcl_mobitems:blaze_rod"},
        {"ec_matter:dark_matter", "mcl_mobitems:blaze_rod", "ec_matter:dark_matter"},
    },
    "looting",
    1,
...
exchangeclone.register_upgrade(
    "ec_upgrades:looting_2_upgrade",
    "Looting II Upgrade",
    "^[multiply:#77ff00",
    {
        {"ec_matter:dark_matter", "mcl_mobitems:blaze_rod", "ec_matter:dark_matter"},
        {"mcl_mobitems:blaze_rod", "ec_upgrades:looting_1_upgrade", "mcl_mobitems:blaze_rod"},
        {"ec_matter:dark_matter", "mcl_mobitems:blaze_rod", "ec_matter:dark_matter"},
    },
    "looting",
    2,
...
exchangeclone.register_upgrade(
    "ec_upgrades:looting_3_upgrade",
    "Looting III Upgrade",
    "^[multiply:#ffff00",
    {
        {"ec_matter:dark_matter", "mcl_mobitems:blaze_rod", "ec_matter:dark_matter"},
        {"mcl_mobitems:blaze_rod", "ec_upgrades:looting_2_upgrade", "mcl_mobitems:blaze_rod"},
        {"ec_matter:dark_matter", "mcl_mobitems:blaze_rod", "ec_matter:dark_matter"},
    },
    "looting",
    3,
...
exchangeclone.register_upgrade(
    "ec_upgrades:thorns_1_upgrade",
    "Thorns I Upgrade",
    "^[multiply:#773300",
    {
        {"ec_matter:dark_matter", "mcl_core:cactus", "ec_matter:dark_matter"},
        {"mcl_core:cactus", "ec_upgrades:blank_upgrade", "mcl_core:cactus"},
        {"ec_matter:dark_matter", "mcl_core:cactus", "ec_matter:dark_matter"},
    },
    "thorns",
    1,
...
exchangeclone.register_upgrade(
    "ec_upgrades:thorns_2_upgrade",
    "Thorns II Upgrade",
    "^[multiply:#441100",
    {
        {"ec_matter:dark_matter", "mcl_core:cactus", "ec_matter:dark_matter"},
        {"mcl_core:cactus", "ec_upgrades:thorns_1_upgrade", "mcl_core:cactus"},
        {"ec_matter:dark_matter", "mcl_core:cactus", "ec_matter:dark_matter"},
    },
    "thorns",
    2,
...
exchangeclone.register_upgrade(
    "ec_upgrades:thorns_3_upgrade",
    "Thorns III Upgrade",
    "^[multiply:#220500",
    {
        {"ec_matter:dark_matter", "mcl_core:cactus", "ec_matter:dark_matter"},
        {"mcl_core:cactus", "ec_upgrades:thorns_2_upgrade", "mcl_core:cactus"},
        {"ec_matter:dark_matter", "mcl_core:cactus", "ec_matter:dark_matter"},
    },
    "thorns",
    3,
...
exchangeclone.register_upgrade(
    "ec_upgrades:frost_walker_1_upgrade",
    "Frost Walker I Upgrade",
    "^[multiply:#77aaff",
    {
        {"ec_matter:dark_matter", "mcl_core:packed_ice", "ec_matter:dark_matter"},
        {"mcl_core:packed_ice", "ec_upgrades:blank_upgrade", "mcl_core:packed_ice"},
        {"ec_matter:dark_matter", "mcl_core:packed_ice", "ec_matter:dark_matter"},
    },
    "frost_walker",
    1,
    {
        ["ec_tools:boots_dark_matter"] = true,
        ["ec_tools:boots_red_matter"] = true,
    }
)

exchangeclone.register_upgrade(
    "ec_upgrades:frost_walker_2_upgrade",
    "Frost Walker II Upgrade",
    "^[multiply:#77ffff",
    {
        {"ec_matter:dark_matter", "mcl_core:packed_ice", "ec_matter:dark_matter"},
        {"mcl_core:packed_ice", "ec_upgrades:frost_walker_1_upgrade", "mcl_core:packed_ice"},
        {"ec_matter:dark_matter", "mcl_core:packed_ice", "ec_matter:dark_matter"},
    },
    "frost_walker",
    2,
...
exchangeclone.register_upgrade(
    "ec_upgrades:depth_strider_1_upgrade",
    "Depth Strider I Upgrade",
    "^[multiply:#000066",
    {
        {"ec_matter:dark_matter", "mcl_fishing:salmon_raw", "ec_matter:dark_matter"},
        {"mcl_fishing:salmon_raw", "ec_upgrades:blank_upgrade", "mcl_fishing:salmon_raw"},
        {"ec_matter:dark_matter", "mcl_fishing:salmon_raw", "ec_matter:dark_matter"},
    },
    "depth_strider",
    1,
...
exchangeclone.register_upgrade(
    "ec_upgrades:depth_strider_2_upgrade",
    "Depth Strider II Upgrade",
    "^[multiply:#0000aa",
    {
        {"ec_matter:dark_matter", "mcl_fishing:salmon_raw", "ec_matter:dark_matter"},
        {"mcl_fishing:salmon_raw", "ec_upgrades:depth_strider_1_upgrade", "mcl_fishing:salmon_raw"},
        {"ec_matter:dark_matter", "mcl_fishing:salmon_raw", "ec_matter:dark_matter"},
    },
    "depth_strider",
    2,
...
exchangeclone.register_upgrade(
    "ec_upgrades:depth_strider_3_upgrade",
    "Depth Strider III Upgrade",
    "^[multiply:#0000ff",
    {
        {"ec_matter:dark_matter", "mcl_fishing:salmon_raw", "ec_matter:dark_matter"},
        {"mcl_fishing:salmon_raw", "ec_upgrades:depth_strider_2_upgrade", "mcl_fishing:salmon_raw"},
        {"ec_matter:dark_matter", "mcl_fishing:salmon_raw", "ec_matter:dark_matter"},
    },
    "depth_strider",
    3,
...
exchangeclone.register_upgrade(
    "ec_upgrades:soul_speed_1_upgrade",
    "Soul Speed I Upgrade",
    "^[brighten^[invert:rgb^[brighten^[multiply:#181400",
    {
        {"ec_matter:dark_matter", "mcl_blackstone:soul_soil", "ec_matter:dark_matter"},
        {"mcl_blackstone:soul_soil", "ec_upgrades:blank_upgrade", "mcl_blackstone:soul_soil"},
        {"ec_matter:dark_matter", "mcl_blackstone:soul_soil", "ec_matter:dark_matter"},
    },
    "soul_speed",
    1,
...
exchangeclone.register_upgrade(
    "ec_upgrades:soul_speed_2_upgrade",
    "Soul Speed II Upgrade",
    "^[brighten^[invert:rgb^[brighten^[multiply:#2c2000",
    {
        {"ec_matter:dark_matter", "mcl_blackstone:soul_soil", "ec_matter:dark_matter"},
        {"mcl_blackstone:soul_soil", "ec_upgrades:soul_speed_1_upgrade", "mcl_blackstone:soul_soil"},
        {"ec_matter:dark_matter", "mcl_blackstone:soul_soil", "ec_matter:dark_matter"},
    },
    "soul_speed",
    2,
...
exchangeclone.register_upgrade(
    "ec_upgrades:soul_speed_3_upgrade",
    "Soul Speed III Upgrade",
    "^[brighten^[invert:rgb^[brighten^[multiply:#352700",
    {
        {"ec_matter:dark_matter", "mcl_blackstone:soul_soil", "ec_matter:dark_matter"},
        {"mcl_blackstone:soul_soil", "ec_upgrades:soul_speed_2_upgrade", "mcl_blackstone:soul_soil"},
        {"ec_matter:dark_matter", "mcl_blackstone:soul_soil", "ec_matter:dark_matter"},
    },
    "soul_speed",
    3,
...
exchangeclone.register_upgrade(
    "ec_upgrades:silk_touch_upgrade",
    "Silk Touch Upgrade",
    "^[brighten",
    {
        {"ec_matter:dark_matter", "mcl_core:cobweb", "ec_matter:dark_matter"},
        {"mcl_core:cobweb", "ec_upgrades:blank_upgrade", "mcl_core:cobweb"},
        {"ec_matter:dark_matter", "mcl_core:cobweb", "ec_matter:dark_matter"},
    },
    "silk_touch",
    1,
    {
        ...
        ["ec_tools:dark_matter_axe"] = true,
        ["ec_tools:red_matter_axe"] = true,
        ["ec_tools:dark_matter_shovel"] = true,
        ["ec_tools:red_matter_shovel"] = true,
        ["ec_tools:dark_matter_shears"] = true,
        ["ec_tools:red_matter_shears"] = true,
...
exchangeclone.register_upgrade(
    "ec_upgrades:fortune_1_upgrade",
    "Fortune I Upgrade",
    "^[multiply:#ff00ff",
    {
        {"ec_matter:dark_matter", "mcl_core:diamond", "ec_matter:dark_matter"},
        {"mcl_core:diamond", "ec_upgrades:blank_upgrade", "mcl_core:diamond"},
        {"ec_matter:dark_matter", "mcl_core:diamond", "ec_matter:dark_matter"},
    },
    "fortune",
    1,
...
exchangeclone.register_upgrade(
    "ec_upgrades:fortune_2_upgrade",
    "Fortune II Upgrade",
    "^[multiply:#aa00ff",
    {
        {"ec_matter:dark_matter", "mcl_core:diamond", "ec_matter:dark_matter"},
        {"mcl_core:diamond", "ec_upgrades:fortune_1_upgrade", "mcl_core:diamond"},
        {"ec_matter:dark_matter", "mcl_core:diamond", "ec_matter:dark_matter"},
    },
    "fortune",
    2,
...
exchangeclone.register_upgrade(
    "ec_upgrades:fortune_3_upgrade",
    "Fortune III Upgrade",
    "^[multiply:#7700ff",
    {
        {"ec_matter:dark_matter", "mcl_core:diamond", "ec_matter:dark_matter"},
        {"mcl_core:diamond", "ec_upgrades:fortune_2_upgrade", "mcl_core:diamond"},
        {"ec_matter:dark_matter", "mcl_core:diamond", "ec_matter:dark_matter"},
    },
    "fortune",
    3,
...
exchangeclone.register_upgrade(
    "ec_upgrades:curse_of_vanishing_upgrade",
    "Curse of Vanishing \"Upgrade\"",
    "^[invert:rgb",
    {
        {"ec_matter:dark_matter", "xpanes:pane_silver_flat", "ec_matter:dark_matter"},
        {"xpanes:pane_silver_flat", "ec_upgrades:blank_upgrade", "xpanes:pane_silver_flat"},
        {"ec_matter:dark_matter", "xpanes:pane_silver_flat", "ec_matter:dark_matter"},
    },
    "curse_of_vanishing",
    1,
...
core.register_alias("exchangeclone:blank_upgrade", "ec_upgrades:blank_upgrade")
core.register_alias("exchangeclone:upgrader", "ec_upgrades:upgrader")