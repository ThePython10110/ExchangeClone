...
core.register_tool("ec_alchemical_books:basic_alchemical_book", {
...
core.register_tool("ec_alchemical_books:advanced_alchemical_book", {
...
core.register_tool("ec_alchemical_books:master_alchemical_book", {
...
if core.get_modpath("ec_magic_items") then
    core.register_tool("ec_alchemical_books:arcane_alchemical_book", {
...
core.register_craft({
    output = "ec_alchemical_books:basic_alchemical_book",
    recipe = {
        {"ec_dust:low_covalence_dust","ec_matter:red_matter", "ec_dust:low_covalence_dust"},
        {craftitem, exchangeclone.itemstrings.book, "ec_phil:philosophers_stone"},
        {"ec_dust:low_covalence_dust","ec_matter:red_matter", "ec_dust:low_covalence_dust"},
    }
})

core.register_craft({
    output = "ec_alchemical_books:advanced_alchemical_book",
    recipe = {
        {"ec_dust:medium_covalence_dust","ec_matter:pink_matter", "ec_dust:medium_covalence_dust"},
        {craftitem, "ec_alchemical_books:basic_alchemical_book", "ec_matter:pink_matter"},
        {"ec_dust:medium_covalence_dust","ec_matter:pink_matter", "ec_dust:medium_covalence_dust"},
    }
})

core.register_craft({
    output = "ec_alchemical_books:master_alchemical_book",
    recipe = {
        {"ec_dust:high_covalence_dust","ec_matter:violet_matter", "ec_dust:high_covalence_dust"},
        {"ec_matter:violet_matter", "ec_alchemical_books:advanced_alchemical_book", "ec_matter:violet_matter"},
        {"ec_dust:high_covalence_dust","ec_matter:violet_matter", "ec_dust:high_covalence_dust"},
    }
})
...
if core.get_modpath("ec_magic_items") then
    core.register_craft({
        output = "ec_alchemical_books:arcane_alchemical_book",
        recipe = {
            {"ec_magic_items:void_ring","ec_matter:cyan_matter_block", "ec_magic_items:void_ring"},
            {"ec_magic_items:void_ring", "ec_alchemical_books:master_alchemical_book", "ec_magic_items:void_ring"},
            {"ec_magic_items:void_ring","ec_matter:cyan_matter_block", "ec_magic_items:void_ring"},
        }
    })
end
