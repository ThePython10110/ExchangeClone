...
local function black_hole_pedestal(pos)
    ...
    for _, neighbor_pos in ipairs(exchangeclone.neighbors) do
        ...
        if core.get_node(new_pos).name == "ec_chests:alchemical_chest" then
...
core.register_tool("ec_magic_items:black_hole_band", {
...
core.register_tool("ec_magic_items:void_ring", {
    ...
    _exchangeclone_passive = {
        ...
        exclude = {"ec_magic_items:black_hole_band", "ec_magic_items:gem_of_eternal_density"}
    },
    _exchangeclone_pedestal = black_hole_pedestal,
})
...
core.register_craft({
    output = "ec_magic_items:void_ring",
    type = "shapeless",
    recipe = {
        "ec_magic_items:black_hole_band",
        "ec_magic_items:gem_of_eternal_density",
