...
core.register_tool("ec_magic_items:soul_stone", {
    ...
    _exchangeclone_passive = {
        ...
        exclude = {"ec_magic_items:life_stone"}
    },
...
core.register_craft({
    output = "ec_magic_items:soul_stone",
    recipe = {
        ...
        {"ec_matter:red_matter", exchangeclone.itemstrings.lapisworth, "ec_matter:red_matter"},
        {exchangeclone.itemstrings.glowstoneworth, exchangeclone.itemstrings.glowstoneworth, exchangeclone.itemstrings.glowstoneworth},
    }
})

if (exchangeclone.mcl and mcl_hunger.active) or (exchangeclone.mtg and core.get_modpath("stamina")) then
    core.register_tool("ec_magic_items:body_stone", {
    ...
    core.register_craft({
        output = "ec_magic_items:body_stone",
        recipe = {
    ...
    core.register_tool("ec_magic_items:life_stone", {
        ...
        _exchangeclone_passive = {
            ...
            exclude = {"ec_magic_items:body_stone", "ec_magic_items:soul_stone"}
        },
        _exchangeclone_pedestal = function(pos)
            for _, object in pairs(core.get_objects_inside_radius(pos, 5)) do
                if object:is_player() then
    ...
    core.register_craft({
        output = "ec_magic_items:life_stone",
        type = "shapeless",
        recipe = {"ec_magic_items:soul_stone", "ec_magic_items:body_stone"}
    })
end
...
if exchangeclone.mcl then
    ...
    core.register_tool("ec_magic_items:mind_stone", {
    ...
    core.register_craft({
        output = "ec_magic_items:mind_stone",
        recipe = {
            {book, book, book},
            {"ec_matter:red_matter", exchangeclone.itemstrings.lapisworth, "ec_matter:red_matter"},
            {book, book, book},
