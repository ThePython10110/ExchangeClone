...
core.register_tool("ec_magic_items:infinite_food", {
...
core.register_on_item_eat(function(hp_change, replace_with_item, itemstack, player, pointed_thing)
    if itemstack:get_name() == "ec_magic_items:infinite_food" then
        player:_add_emc(-64)
    end
end)
...
core.register_craft({
    output = "ec_magic_items:infinite_food",
    recipe = {
        {bread_itemstring, bread_itemstring, bread_itemstring,},
        {bread_itemstring, "ec_transmutation:transmutation_tablet", bread_itemstring,},
        {bread_itemstring, bread_itemstring, bread_itemstring,},
    }
})
