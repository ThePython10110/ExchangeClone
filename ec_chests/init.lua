...
core.register_node("ec_chests:alchemical_chest", {
...
local dye_mod = ((exchangeclone.mcla and "mcl_dyes") or (exchangeclone.mcl2 and "mcl_dye")) or "dye"

for color, color_data in pairs(exchangeclone.colors) do
    local bag_itemstring = "ec_chests:alchemical_bag_"..color
    local advanced_itemstring = "ec_chests:advanced_alchemical_chest_"..color
    local wool_itemstring = (exchangeclone.mcl and "mcl_wool:" or "wool:")..color
    local dye_itemstring = dye_mod..":"..color
    ...
    core.register_craft({
        ...
        recipe = {
            {"ec_dust:high_covalence_dust", "ec_dust:high_covalence_dust", "ec_dust:high_covalence_dust"},
            {wool_itemstring, "ec_chests:alchemical_chest", wool_itemstring},
    ...
    core.register_craft({
        ...
        recipe = {
            {"ec_matter:dark_matter", "ec_dust:low_covalence_dust", "ec_matter:dark_matter"},
            {"ec_dust:medium_covalence_dust", "ec_chests:alchemical_bag_"..color, "ec_dust:medium_covalence_dust"},
            {"ec_dust:high_covalence_dust", "ec_dust:low_covalence_dust", "ec_dust:high_covalence_dust"},
        }
    })
    core.register_craft({
        output = advanced_itemstring,
    ...
    core.register_alias("exchangeclone"..advanced_itemstring:sub(10), advanced_itemstring)
    core.register_alias("exchangeclone"..bag_itemstring:sub(10), advanced_itemstring)
end

core.register_alias("exchangeclone:alchemical_chest", "ec_chests:alchemical_chest")