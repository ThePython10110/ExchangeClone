...
function exchangeclone.mine_vein(player, start_pos, node_name, pos, depth, visited)
    ...
    if node_name == node.name then
        local drops = core.get_node_drops(node.name, "ec_tools:red_matter_pickaxe")
...
exchangeclone.register_multidig_tool("ec_tools:dark_matter_pickaxe", {"group:"..exchangeclone.pickaxe_group})
core.register_alias("ec_tools:dark_matter_pickaxe_3x1", "ec_tools:dark_matter_pickaxe")
...
exchangeclone.register_multidig_tool("ec_tools:red_matter_pickaxe", {"group:"..exchangeclone.pickaxe_group})
exchangeclone.set_charge_type("ec_tools:red_matter_pickaxe", "red_matter")

core.register_craft({
    output = "ec_tools:dark_matter_pickaxe",
    recipe = {
        {"ec_matter:dark_matter", "ec_matter:dark_matter", "ec_matter:dark_matter"},
...
core.register_craft({
    output = "ec_tools:red_matter_pickaxe",
    recipe = {
        {"ec_matter:red_matter", "ec_matter:red_matter", "ec_matter:red_matter"},
...
core.register_alias("exchangeclone:dark_matter_pickaxe", "ec_tools:dark_matter_pickaxe")
core.register_alias("exchangeclone:red_matter_pickaxe", "ec_tools:red_matter_pickaxe")
core.register_alias("exchangeclone:red_matter_pickaxe_3x1", "ec_tools:red_matter_pickaxe")