...
core.register_tool("ec_tools:dark_matter_axe", {
...
exchangeclone.set_charge_type("ec_tools:dark_matter_axe", "dark_matter")

core.register_tool("ec_tools:red_matter_axe", {
...
exchangeclone.set_charge_type("ec_tools:red_matter_axe", "red_matter")

core.register_craft({
    output = "ec_tools:dark_matter_axe",
    recipe = {
        {"ec_matter:dark_matter", "ec_matter:dark_matter"},
        {"ec_matter:dark_matter", exchangeclone.itemstrings.diamond},
        {"", exchangeclone.itemstrings.diamond}
    }
})

core.register_craft({
    output = "ec_tools:red_matter_axe",
    recipe = {
        {"ec_matter:red_matter", "ec_matter:red_matter"},
        {"ec_matter:red_matter", "ec_tools:dark_matter_axe"},
        {"", "ec_matter:dark_matter"}
    }
})

core.register_alias("exchangeclone:dark_matter_axe", "ec_tools:dark_matter_axe")
core.register_alias("exchangeclone:red_matter_axe", "ec_tools:red_matter_axe")