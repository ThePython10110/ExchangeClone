...
core.register_tool("ec_tools:dark_matter_sword", {
...
core.register_tool("ec_tools:red_matter_sword", {
...
core.register_craft({
    output = "ec_tools:dark_matter_sword",
    recipe = {
...
core.register_craft({
	output = "ec_tools:red_matter_sword",
	recipe = {
		{"ec_matter:red_matter"},
		{"ec_matter:red_matter"},
		{"ec_tools:dark_matter_sword"},
	}
})

core.register_alias("exchangeclone:dark_matter_sword", "ec_tools:dark_matter_sword")
core.register_alias("exchangeclone:red_matter_sword", "ec_tools:red_matter_sword")