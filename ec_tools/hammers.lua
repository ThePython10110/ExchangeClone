...
exchangeclone.register_multidig_tool("ec_tools:dark_matter_hammer", {"group:"..exchangeclone.pickaxe_group})
core.register_alias("ec_tools:dark_matter_hammer_3x3", "ec_tools:dark_matter_hammer")
...
exchangeclone.register_multidig_tool("ec_tools:red_matter_hammer", {"group:"..exchangeclone.pickaxe_group})
exchangeclone.set_charge_type("ec_tools:red_matter_hammer", "red_matter")

core.register_craft({
    output = "ec_tools:dark_matter_hammer",
    recipe = {
...
core.register_craft({
    output = "ec_tools:red_matter_hammer",
    recipe = {
        {"ec_matter:red_matter", "ec_matter:dark_matter", "ec_matter:red_matter"},
        {"", "group:dark_matter_hammer", ""},
        {"", "ec_matter:dark_matter", ""}
    }
})

core.register_alias("exchangeclone:dark_matter_hammer", "ec_tools:dark_matter_hammer")
core.register_alias("exchangeclone:red_matter_hammer", "ec_tools:red_matter_hammer")
core.register_alias("exchangeclone:red_matter_hammer_3x3", "ec_tools:red_matter_hammer")