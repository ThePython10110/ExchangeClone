core.register_tool("exchangeclone:zero_ring", {
...
core.register_tool("exchangeclone:ring_of_ignition", {
    ...
    _exchangeclone_passive = {
        func = function(player)
            ...
            core.log(dump({start = start, _end = _end}))
             -- conveniently, MTG and MCL agree on the flammable group
            local nodes = core.find_nodes_in_area(start, _end, "group:flammable")
