...
if core.get_modpath("ec_phil") then
...
if core.get_modpath("ec_transmutation") then
...
if core.get_modpath("ec_stars") then
...
if core.get_modpath("ec_chests") then
...
if core.get_modpath("ec_tools") then
...
if core.get_modpath("ec_furnaces") then
    register_award("exchangeclone:hot_matter", {
        ...
        trigger = {
            type = "craft",
            item = "ec_furnaces:dark_matter_furnace",
            target = 1,
        }
    })
    ...
    register_award("exchangeclone:even_hotter_matter", {
        ...
        trigger = {
            type = "craft",
            item = "ec_furnaces:red_matter_furnace",
            target = 1,
        }
    })
end

if core.get_modpath("ec_collectors") then
...
if core.get_modpath("ec_matter") then
    ...
    register_award("exchangeclone:block_that_matters", {
        ...
        trigger = {
            type = "craft",
            item = "ec_matter:dark_matter_block",
            target = 1,
        }
    })
    ...
    register_award("exchangeclone:red_and_shiny", {
        ...
        trigger = {
            type = "craft",
            item = "ec_matter:red_matter_block",
            target = 1,
        }
    })
end

if core.get_modpath("ec_upgrades") then
